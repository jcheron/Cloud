		...
		if(isset($user)){
			...
			$infoUser='<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="Accueil/asAdmin"><span class="glyphicon glyphicon-king" aria-hidden="true"></span>&nbsp;Administrateur</a></li>
								<li><a href="Accueil/asUser"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;Utilisateur</a></li>
